webvowl.app = function (e) {
    ...
    0: function (e, t, n) {
        ...
        var r = n(87), a = n(90), i = n(91), l = "[object Null]", s = "[object Undefined]",
            c = r ? r.toStringTag : void 0;
        e.exports = o
    }, 87: function (e, t, n) {
        var o = n(88), r = o.Symbol;
        e.exports = r
    }, 88: function (e, t, n) {
        var o = n(89), r = "object" == typeof self && self && self.Object === Object && self,
        ...
        var r = n(87), a = Object.prototype, i = a.hasOwnProperty, l = a.toString, s = r ? r.toStringTag : void 0;
        e.exports = o
    }, 91: function (e, t) {
        function n(e) {
            return r.call(e)
        ...
        var r = n(86), a = n(99), i = "[object Symbol]";
        e.exports = o
    }, 99: function (e, t) {
        function n(e) {
        ...
        var r = n(87), a = n(149), i = n(107), l = n(98), s = 1 / 0, c = r ? r.prototype : void 0,
            ...
            e.exports = function () {
                function e(e, t, n) {
                    ...
                    if (e) {
                        ...
                        if (!t) {
                            var a = o.header ? o.header.title : void 0, c = s.textInLanguage(a);
                            t = c ? c : n
                        }
                    }
                    var u = parseInt(o.metrics.classCount), p = parseInt(o.metrics.objectPropertyCount),
                ...
                function o() {
                    var e = t.select(c), n = e.select("svg"), o = window.innerHeight - 40,
                ...
                var a = {}, i = webvowl.graph(), l = i.graphOptions(), s = webvowl.util.languageTools(), c = "#graph",
                    d = n(318)(i), u = n(319)(i), p = n(320)(i), f = n(321)(i), h = n(322)(i), v = n(326)(i),
                    g = n(327)(i), y = n(328)(i), m = n(329)(i), b = n(330)(i),
                    x = webvowl.modules.colorExternalsSwitch(i), k = webvowl.modules.compactNotationSwitch(i),
                    C = webvowl.modules.datatypeFilter(), w = webvowl.modules.disjointFilter(),
                    S = webvowl.modules.focuser(), O = webvowl.modules.emptyLiteralFilter(),
                    E = webvowl.modules.nodeDegreeFilter(u), A = webvowl.modules.nodeScalingSwitch(i),
                    I = webvowl.modules.objectPropertyFilter(), D = webvowl.modules.pickAndPin(),
                    M = webvowl.modules.selectionDetailsDisplayer(b.updateSelectionInformation),
                    L = webvowl.modules.statistics(), R = webvowl.modules.subclassFilter(),
                ...
                return a.initialize = function () {
                    ...
                    var n = r();
                    if (console.log("agent Version " + n), n > 0 && n <= 11) console.log("this agent is not supported"), t.select("#browserCheck").classed("hidden", !1), t.select("#killWarning").classed("hidden", !0), t.select("#optionsArea").classed("hidden", !0), t.select("#logo").classed("hidden", !0); else {
                        ...
                        var a, s = i.options().width(), j = i.options().height();
        ...
        (function (t) {
            e.exports = function (e) {
                ...
                function o(e) {
                    var t, n, o, r = [], a = e.length;
                    for (t = 0; t < a; t++)n = e.charAt(t), o = n.charCodeAt(0), o < 128 ? r.push(n) : r.push("&#" + o + ";");
                    return r.join("")
                }

                function r() {
                    a(".text", [{name: "font-family", value: "Helvetica, Arial, sans-serif"}, {
                        name: "font-size",
                        value: "12px"
                    }]), a(".subtext", [{name: "font-size", value: "9px"}]), a(".text.instance-count", [{
                        name: "fill",
                        value: "#666"
                        ...
                        name: "fill",
                        value: "#36c"
                    }]), a("path, .nofill", [{name: "fill", value: "none"}]), a("marker path", [{
                        name: "fill",
                        value: "#000"
                        ...
                        name: "fill",
                        value: "#f00"
                    }, {name: "cursor", value: "pointer"}]), a(".focused, path.hovered", [{
                        name: "stroke",
                        value: "#f00"
                        ...
                        name: "stroke-width",
                        value: "4px"
                    }]), a(".nostroke", [{name: "stroke", value: "none"}]), a("marker path", [{
                        name: "stroke-dasharray",
                        value: "100"
                    }])
                }
                ...
                function c() {
                    t.selectAll(".text, .subtext, .text.instance-count, .external + text .instance-count, .cardinality, .text, .embedded, .class, .object, .disjoint, .objectproperty, .disjointwith, .equivalentproperty, .transitiveproperty, .functionalproperty, .inversefunctionalproperty, .symmetricproperty, .allvaluesfromproperty, .somevaluesfromproperty, .label .datatype, .datatypeproperty, .rdf, .rdfproperty, .literal, .node .datatype, .deprecated, .deprecatedproperty, .external, .externalproperty, path, .nofill, .symbol, .values-from.filled, marker path, .class, path, line, .fineline, .white, .subclass, .subclassproperty, .external + text, .class.hovered, .property.hovered, .cardinality.hovered, .cardinality.focused, circle.pin, .filled.hovered, .filled.focused, .focused, path.hovered, .indirect-highlighting, .feature:hover, .values-from, .class, path, line, .fineline, .dashed, .anonymous, .dotted, rect.focused, circle.focused, .nostroke, marker path").each(function () {
                        var e = t.select(this), n = e.node().style;
                ...
                function u() {
                    ...
                    var n, o = e.graphNodeElements(), r = e.graphLabelElements(), a = JSON.parse(v), i = a._comment,
                    ...
                    var s = a.classAttribute, c = a.propertyAttribute;
                    ...
                    var D = e.options().modeMenu(), M = D.getCheckBoxContainer(), L = [];
                    ...
                    var j = JSON.stringify(N, null, "  "), F = "data:text/json;charset=utf-8," + encodeURIComponent(j);
        ...
        (function (t) {
            e.exports = function (e) {
                ...
                function r() {
                    ...
                    var r = parseInt(l.property("value")), a = r + n;
                ...
                var i, l, s = {}, c = [], d = t.select("#filterOption a"), u = t.select("#nodeDegreeFilteringOption");
                return s.getCheckBoxContainer = function () {
                    ...
                    c.forEach(function (e) {
                        var t = e.checkbox, n = e.defaultState, o = t.property("checked");
        ...
        (function (t) {
            e.exports = function (e) {
                function n(n, r, i, l) {
                    var s, c, d = l();
                    s = t.select(n).append("div").datum({distanceFunction: l}).classed("distanceSliderContainer", !0);
                    ...
                    s.append("label").classed("description", !0).attr("for", r + "DistanceSlider").text(i), c = s.append("label").classed("value", !0).attr("for", r + "DistanceSlider").text(l()), a.push(u), u.on("focusout", function () {
                        ...
                        var o = parseInt(u.property("value")), r = o + e;
                        r !== o && (u.property("value", r), l(r), u.on("input")())
                    })
                }

                function o(e) {
                    var t = Math.max(i.classDistance(), i.datatypeDistance()), n = t / e, o = l * n;
                    i.charge(o)
                }

                var r = {}, a = [], i = e.graphOptions(), l = i.charge();
        ...
        (function (t) {
            e.exports = function (e) {
                ...
                function r(t, n) {
                    var o = t.append("button").datum({active: !1}).classed("color-mode-switch", !0);
                ...
                var l, s = {text: "Multicolor", type: "same"}, c = {text: "Multicolor", type: "gradient"}, d = {},
                    u = [];
                return d.colorModeState = function (e) {
                    ...
                    u.forEach(function (e) {
                        var t = e.datum().defaultState, n = e.property("checked");
            ...
            e.exports = function (e) {
                function n() {
                    a(), t.select(window).on("hashchange", function () {
                        var e = t.event.oldURL, n = t.event.newURL;
                        if (e !== n) {
                            if (n === e + "#")return;
                            r(), a()
                        }
                ...
                function a() {
                    ...
                    } else l("production/data/" + e + ".json", e), n.each(function () {
                        var n = t.select(this);
                ...
                function i(n, o) {
                    b = o;
                    var r = E[n], a = o.replace(/\/$/g, ""), i = a.slice(a.lastIndexOf("/") + 1),
                ...
                function l(n, o) {
                    ...
                    r ? (x(r, void 0, i), g(!0)) : (v(), t.xhr(n, "application/json", function (t, o) {
                        ...
                        var l;
                        if (a) l = o.responseText, E[n] = l; else if (404 === t.status) {
                            var s = "iri=", c = "url=", d = "file=", u = location.hash.slice(1);
                ...
                function s() {
                    var e = t.select("#iri-converter-button"), n = t.select("#iri-converter-input");
                    n.on("input", function () {
                        h();
                ...
                function c() {
                    var e = t.select("#file-converter-input"), n = t.select("#file-converter-label"),
                ...
                function g(e, n, r) {
                    ...
                    var i = !n, l = t.select("#error-description-button").classed("hidden", i).datum().open;
                ...
                var m, b, x, k = {}, C = "foaf", w = t.select("#loading-error"), S = t.select("#loading-progress"),
                    O = !1, E = {};
                return String.prototype.beginsWith = function (e) {
                    ...
                    var a = t.select("#error-description-button").datum({open: !1});
                    a.on("click", function (e) {
                        var n = t.select("#error-description-container"), o = t.select(this);
                        e.open = !e.open;
                        var r = e.open;
                    ...
                    var o = "There is no OWL input under the given IRI(" + b + "). Please try to load the OWL file directly.",
                        r = !o, a = t.select("#error-description-button").classed("hidden", r).datum().open;
                    ...
                    var o = "The uploaded file is not a valid JSON file. (" + b + ")", r = !o,
        ...
        var r = n(214), a = n(324), i = /&(?:amp|lt|gt|quot|#39);/g, l = RegExp(i.source);
        e.exports = o
    }, 324: function (e, t, n) {
        var o = n(325), r = {"&amp;": "&", "&lt;": "<", "&gt;": ">", "&quot;": '"', "&#39;": "'"}, a = o(r);
        e.exports = a
            ...
            e.exports = function (e) {
                ...
                return i.setup = function () {
                    ...
                    o.on("mouseover", function () {
                        var t = e.options().searchMenu();
                        t.hideSearchEntries()
                    }), a = t.select("#pause-button").datum({paused: !1}).on("click", function (t) {
        ...
        (function (t) {
            e.exports = function (e) {
                ...
                var o, r = {}, a = e.graphOptions(), i = webvowl.options();
            ...
            e.exports = function (e) {
                function n() {
                    ...
                    for (t = 0; t < h.length; t++) {
                        ...
                        if (n.push(h[t].id()), o.push(r), h[t].equivalents && h[t].equivalents().length > 0)for (var a = h[t].equivalentsString(), i = a.split(", "), l = 0; l < i.length; l++)n.push(h[t].id()), o.push(i[l])
                    }
                    p = [], f = [];
                    var s, c, d = -1;
                    for (t = 0; t < o.length; t++)if (0 !== t)if (s = o[t], c = n[t], d = p.indexOf(s), d === -1) {
                        p.push(o[t]), f.push([]);
                        var u = f.length;
                        f[u - 1].push(c)
                    } else f[d].push(c); else p.push(o[t]), f.push([]), f[0].push(n[t]);
                ...
                function s() {
                    ...
                    var o, r = u.node().children, a = r.length;
                ...
                var d, u, p, f, h, v, g = {}, y = [], m = [], b = 6, x = !0, k = !1;
                return String.prototype.beginsWith = function (e) {
                    return 0 === this.indexOf(e)
            ...
            e.exports = function (e) {
                function n() {
                    u.on("mouseover", function () {
                        ...
                        var e, t, n;
                        if (1 !== c[0]) {
                            var o = c.indexOf(1) - 1, l = c.indexOf(1);
                ...
                function a() {
                    ...
                    var e = s.length - 2, t = s.length - 1, n = c.indexOf(1);
                    n === -1 && (o(), n = c.indexOf(1));
                    var r = s[n].getBoundingClientRect().top, a = s[e].getBoundingClientRect().top,
                ...
                var l = {}, s = [], c = [], d = t.select("#optionsMenu"), u = t.select("#LeftButton"),
                ...
                return l.setup = function () {
                    ...
                    var d = c.indexOf(1), u = c.lastIndexOf(1);
            ...
            e.exports = function (e) {
                function n() {
                    ...
                    e(t.selectAll(".accordion-trigger:not(.accordion-trigger-active) + div")), o.on("click", function () {
                        var o = t.select(this), r = t.selectAll(".accordion-trigger-active");
                ...
                function y(e) {
                    ...
                    var o = t.select("#disjointNodes"), r = t.select(o.node().parentNode);
                ...
                function x(e, n) {
                    var o = t.select(e.node().parentNode), r = !!n;
                    n && e.text(n), o.classed("hidden", !r)
                }

                var k, C, w = {}, S = webvowl.util.languageTools(), O = webvowl.util.elementTools();
                return w.setup = function () {
                    ...
                    if (C = e, !t.event || !t.event.defaultPrevented) {
                        var n = t.select("#selection-details-trigger").classed("accordion-trigger-active");
                        if (e && !n) t.select("#selection-details-trigger").node().click(); else if (!e && n)return void c();
